...
# Windows" component of Visual Studio 2022) and Visual Studio 2022's MSVC
...
if(NOT DEFINED ENV{VCToolsInstallDir})
    if(NOT SBSP_VCTOOLSDIR)
        ...
        list(SORT _sbsp_vc COMPARE NATURAL)
        list(LENGTH _sbsp_vc _n)
        if(_n EQUAL 0)
            message(FATAL_ERROR "No MSVC toolset found under Visual Studio 2022/2019 (VC/Tools/MSVC/<ver>): install the 'MSVC v143 - VS 2022 C++ x64/x86 build tools' component or set SBSP_VCTOOLSDIR")
        endif()
        list(GET _sbsp_vc -1 SBSP_VCTOOLSDIR)
    endif()
