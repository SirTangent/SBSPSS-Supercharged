...
rem Usage: port\build-pc.cmd [debug^|final^|usa-debug^|usa-final^|eur-debug^|eur-final^|clangcl-debug^|clangcl-final^|clangcl-x64-debug^|clangcl-x64-final^|usa^|eur^|clangcl^|clangcl64^|all^|test [usa^|eur^|clangcl^|clangcl64]^|soak [usa^|eur^|clangcl^|clangcl64]]
