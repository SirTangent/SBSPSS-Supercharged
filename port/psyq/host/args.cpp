...
static void usage(void)
{
	fprintf(stderr,
		...
		"                        key_<button> prompt_icons pad_deadzone rumble\n"
		"                        pause_on_focus_loss language data_dir (SBSP_<KEY>)\n"
		"                        prompt_icons auto|keys|pad picks the button-prompt\n"
		"                        icons: the bound key caps, or the PS1 glyphs\n"
